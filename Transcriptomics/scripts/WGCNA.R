# Eco Genomics WGCNA Fall 2023

## Set your working directory
setwd("~/Documents/GitHub/Ecological_Genomics_23/Transcriptomics/")
...
sample_metadata = read.table(file = "data/Ahud_trait_data.txt",header=T, row.names = 1)
